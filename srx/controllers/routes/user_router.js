...
router.get("/republic",(req, res)=>{
  res.render('pages_mov/republic')
})
router.get("/csi",(req, res)=>{
  res.render('pages_mov/csi')
})
router.get("/rebellion",(req, res)=>{
  res.render('pages_mov/rebellion')
})
router.get("/empire",(req, res)=>{
  res.render('pages_mov/empire')
})
router.get("/jedi",(req, res)=>{
  res.render('pages_mov/jedi')
})
router.get("/sith",(req, res)=>{
  res.render('pages_mov/sith')
})
